...
<body class="bg-gray-50">
    ...
    <div class="pt-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <form action="{{ route('admin.articles.update', $article->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <input type="hidden" name="article_id" value="{{ $article->id }}" id="article-id-input">
                        ...
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="flex items-center justify-between mt-2">
                                    ...
                                    <button type="button" 
                                            onclick="deleteCover()"
                                            class="text-xs text-red-600 hover:text-red-800 bg-red-50 hover:bg-red-100 px-3 py-1 rounded-lg transition-colors font-medium flex items-center gap-1">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="mb-6">
                        ...
                        <p class="text-sm text-gray-600 mb-4">Upload images, copy the markdown code, and paste it into the editor above</p>
                        ...
                        <div id="markdown-result" class="hidden">
                            ...
                            <div id="images-container" class="mb-4">
                            ...
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-3">
                                <p class="text-sm text-blue-900">
                                    <strong>Copy & Paste:</strong> Each markdown code dapat di-copy dan paste ke editor di atas.
                                </p>
                            </div>
                        </div>

                        <!-- Empty State -->
                        <div id="empty-state" class="text-center py-6 text-gray-500">
                            <svg class="w-12 h-12 mx-auto mb-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                            </svg>
                            <p class="text-sm">No image uploaded yet. Upload one to get started!</p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        async function deleteCover() {
            const confirmed = confirm('Delete cover image? If markdown has valid images (≥1000×1000px), one will be auto-selected.');
            if (!confirmed) return;
            ...
            try {
                ...
                const response = await fetch(`/admin/articles/${articleId}/delete-cover`, {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': csrfToken,
                ...
                if (data.success) {
                    ...
                    alert('Error deleting cover image');
                }
            } catch (error) {
                console.error('Error:', error);
                alert('Failed to delete cover image: ' + error.message);
            }
        }
