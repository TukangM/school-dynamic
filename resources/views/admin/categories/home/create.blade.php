    ...
    <div class="pt-6">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-6">
                ...
                <p class="text-gray-600 mt-1">Add a new category section to your homepage</p>
            </div>

            <!-- Form -->
            <form action="{{ route('admin.categories.home.store') }}" method="POST" class="bg-white rounded-lg shadow-md p-6">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <input type="text" 
                           ...
                           required>
                    <p class="text-xs text-gray-500 mt-1">Used in URL: /category/<span id="slug-preview" class="font-semibold">your-slug</span></p>
                    @error('slug')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
